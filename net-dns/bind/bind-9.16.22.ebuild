...
inherit python-r1 autotools toolchain-funcs flag-o-matic db-use user tmpfiles
...
SRC_URI="https://downloads.isc.org/isc/bind9/9.16.22/bind-9.16.22.tar.xz
	doc? ( mirror://gentoo/dyndns-samples.tbz2 )"

LICENSE="Apache-2.0 BSD BSD-2 GPL-2 HPND ISC MPL-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="+berkdb +caps +dlz dnstap doc dnsrps fixed-rrset geoip gssapi json ldap libressl lmdb mysql odbc postgres python selinux static-libs urandom xml +zlib"
