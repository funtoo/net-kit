...
EGO_SUM=(
	...
	"cloud.google.com/go/pubsub v1.4.0/go.mod"
	...
	"github.com/99designs/gqlgen v0.14.0/go.mod"
	...
	"github.com/!azure/go-autorest/autorest/azure/auth v0.5.11/go.mod"
	...
	"github.com/!d!a!t!a-!d!o!g/go-sqlmock v1.3.3/go.mod"
	...
	"github.com/!data!dog/gostackparse v0.5.0/go.mod"
	"github.com/!data!dog/sketches-go v1.2.1"
	"github.com/!data!dog/sketches-go v1.2.1/go.mod"
	"github.com/!data!dog/zstd v1.3.5/go.mod"
	...
	"github.com/!shopify/sarama v1.22.0/go.mod"
	...
	"github.com/antonmedv/expr v1.9.0/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.44.95/go.mod"
	"github.com/aws/aws-sdk-go-v2 v1.0.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/config v1.0.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v1.0.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/feature/ec2/imds v1.0.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/internal/presigned-url v1.0.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/sqs v1.0.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/sts v1.0.0/go.mod"
	...
	"github.com/confluentinc/confluent-kafka-go v1.4.0/go.mod"
	...
	"github.com/elastic/go-elasticsearch/v7 v7.17.1/go.mod"
	...
	"github.com/garyburd/redigo v1.6.3/go.mod"
	...
	"github.com/go-chi/chi v1.5.0/go.mod"
	...
	"github.com/go-pg/pg/v10 v10.0.0/go.mod"
	...
	"github.com/go-redis/redis/v7 v7.1.0/go.mod"
	...
	"github.com/gocql/gocql v0.0.0-20220224095938-0eacd3183625/go.mod"
	"github.com/godbus/dbus/v5 v5.0.4/go.mod"
	"github.com/gofiber/fiber/v2 v2.11.0/go.mod"
	...
	"github.com/gomodule/redigo v1.7.0/go.mod"
	...
	"github.com/google/pprof v0.0.0-20210423192551-a2663126120b/go.mod"
	...
	"github.com/graph-gophers/graphql-go v1.3.0/go.mod"
	...
	"github.com/hashicorp/consul/api v1.0.0/go.mod"
	"github.com/hashicorp/consul/internal v0.1.0/go.mod"
	...
	"github.com/hashicorp/serf v0.8.6/go.mod"
	...
	"github.com/jinzhu/gorm v1.9.10/go.mod"
	...
	"github.com/labstack/echo/v4 v4.2.0/go.mod"
	...
	"github.com/segmentio/kafka-go v0.4.29/go.mod"
	...
	"github.com/shurcoo!l/vfsgen v0.0.0-20180121065927-ffb13db8def0/go.mod"
	...
	"github.com/tidwall/btree v0.3.0/go.mod"
	"github.com/tidwall/btree v1.1.0/go.mod"
	"github.com/tidwall/buntdb v1.2.0/go.mod"
	"github.com/tidwall/gjson v1.6.7/go.mod"
	"github.com/tidwall/gjson v1.6.8/go.mod"
	"github.com/tidwall/gjson v1.12.1/go.mod"
	"github.com/tidwall/grect v0.1.0/go.mod"
	"github.com/tidwall/grect v0.1.4/go.mod"
	...
	"github.com/tidwall/rtred v0.1.2/go.mod"
	"github.com/tidwall/tinyqueue v0.1.1/go.mod"
	...
	"github.com/twitchtv/twirp v8.1.1+incompatible/go.mod"
	...
	"github.com/valyala/fasthttp v1.26.0/go.mod"
	"github.com/valyala/fasthttp v1.34.0/go.mod"
	...
	"github.com/zenazn/goji v1.0.1/go.mod"
	...
	"golang.org/x/exp v0.0.0-20200901203048-c4f52b2c50aa/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20200528110217-3d3490e7e671/go.mod"
	"google.golang.org/genproto v0.0.0-20200618031413-b414f8b61790/go.mod"
	"google.golang.org/genproto v0.0.0-20200726014623-da3ae01ef02d/go.mod"
	...
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.41.0"
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.41.0/go.mod"
	...
	"gopkg.in/jinzhu/gorm.v1 v1.9.1/go.mod"
	"gopkg.in/olivere/elastic.v3 v3.0.75/go.mod"
	"gopkg.in/olivere/elastic.v5 v5.0.84/go.mod"
	...
	"gorm.io/driver/mysql v1.0.1/go.mod"
	"gorm.io/driver/postgres v1.0.0/go.mod"
	"gorm.io/driver/sqlserver v1.0.4/go.mod"
	"gorm.io/gorm v1.9.19/go.mod"
	"gorm.io/gorm v1.20.0/go.mod"
	"gorm.io/gorm v1.20.6/go.mod"
	...
	"k8s.io/api v0.24.4/go.mod"
	"k8s.io/api v0.25.0"
	"k8s.io/api v0.25.0/go.mod"
	"k8s.io/apimachinery v0.17.0/go.mod"
	"k8s.io/apimachinery v0.24.4/go.mod"
	"k8s.io/apimachinery v0.25.0"
	"k8s.io/apimachinery v0.25.0/go.mod"
	"k8s.io/client-go v0.17.0/go.mod"
	"k8s.io/client-go v0.24.4"
	"k8s.io/client-go v0.24.4/go.mod"
...
SRC_URI="https://api.github.com/repos/coredns/coredns/tarball/v1.10.0 -> coredns-v1.10.0.tar.gz
	${EGO_SUM_SRC_URI}"
