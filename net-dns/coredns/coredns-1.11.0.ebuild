...
EGO_SUM=(
	...
	"github.com/!data!dog/appsec-internal-go v1.0.0"
	"github.com/!data!dog/appsec-internal-go v1.0.0/go.mod"
	"github.com/!data!dog/datadog-agent/pkg/obfuscate v0.45.0-rc.1"
	"github.com/!data!dog/datadog-agent/pkg/obfuscate v0.45.0-rc.1/go.mod"
	"github.com/!data!dog/datadog-agent/pkg/remoteconfig/state v0.46.0-rc.4"
	"github.com/!data!dog/datadog-agent/pkg/remoteconfig/state v0.46.0-rc.4/go.mod"
	"github.com/!data!dog/datadog-go/v5 v5.1.1"
	"github.com/!data!dog/datadog-go/v5 v5.1.1/go.mod"
	"github.com/!data!dog/go-libddwaf v1.4.1"
	"github.com/!data!dog/go-libddwaf v1.4.1/go.mod"
	"github.com/!data!dog/go-tuf v0.3.0--fix-localmeta-fork"
	"github.com/!data!dog/go-tuf v0.3.0--fix-localmeta-fork/go.mod"
	"github.com/!data!dog/gostackparse v0.5.0"
	...
	"github.com/antonmedv/expr v1.12.7/go.mod"
	...
	"github.com/ebitengine/purego v0.4.0-alpha.4.0.20230519103000-ee8dcecc618f/go.mod"
	...
	"github.com/google/pprof v0.0.0-20230509042627-b1315fad0c5a/go.mod"
	...
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.53.0"
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.53.0/go.mod"
	...
	"inet.af/netaddr v0.0.0-20220811202034-502d2d690317/go.mod"
	"k8s.io/api v0.27.4"
	"k8s.io/api v0.27.4/go.mod"
	"k8s.io/apimachinery v0.27.4"
	"k8s.io/apimachinery v0.27.4/go.mod"
	"k8s.io/client-go v0.27.4"
	"k8s.io/client-go v0.27.4/go.mod"
...
SRC_URI="https://github.com/coredns/coredns/tarball/9f4aa9d2625bb8b8f13efa98d3ecf1928cd112b6 -> coredns-1.11.0-9f4aa9d.tar.gz
https://direct.funtoo.org/ea/c7/e6/eac7e6516805201ba4de82d86fb905105ea39727be158ff07f96d2ed9e739a7b5d87b07bcd3e20a42773083b5a3fe811b09221aa3577ebf826dd64e1ddde6284 -> coredns-1.11.0-funtoo-go-bundle-32d150a2558fff881fdf498ec0fc40929b2fc997541cef29327756e40b3581814a611114669f73fd424981fa9567941dcc4c605d4f794c1eb012c188fa15bb4d.tar.gz"
...
S="${WORKDIR}/coredns-coredns-9f4aa9d"
