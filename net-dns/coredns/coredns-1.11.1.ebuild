...
EGO_SUM=(
	...
	"github.com/!data!dog/datadog-agent/pkg/remoteconfig/state v0.48.0-devel.0.20230725154044-2549ba9058df"
	"github.com/!data!dog/datadog-agent/pkg/remoteconfig/state v0.48.0-devel.0.20230725154044-2549ba9058df/go.mod"
	"github.com/!data!dog/datadog-go/v5 v5.1.1"
	"github.com/!data!dog/datadog-go/v5 v5.1.1/go.mod"
	"github.com/!data!dog/go-libddwaf v1.4.2"
	"github.com/!data!dog/go-libddwaf v1.4.2/go.mod"
	"github.com/!data!dog/go-tuf v1.0.1-0.5.2"
	"github.com/!data!dog/go-tuf v1.0.1-0.5.2/go.mod"
	...
	"github.com/ebitengine/purego v0.5.0-alpha/go.mod"
	...
	"github.com/quic-go/quic-go v0.37.4/go.mod"
	...
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.54.0"
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.54.0/go.mod"
