...
EGO_SUM=(
	...
	"github.com/!data!dog/datadog-agent/pkg/obfuscate v0.48.0/go.mod"
	"github.com/!data!dog/datadog-agent/pkg/remoteconfig/state v0.48.1"
	"github.com/!data!dog/datadog-agent/pkg/remoteconfig/state v0.48.1/go.mod"
	"github.com/!data!dog/datadog-go/v5 v5.3.0"
	"github.com/!data!dog/datadog-go/v5 v5.3.0/go.mod"
	"github.com/!data!dog/go-libddwaf v1.5.0"
	"github.com/!data!dog/go-libddwaf v1.5.0/go.mod"
	"github.com/!data!dog/go-tuf v1.0.2-0.5.2"
	"github.com/!data!dog/go-tuf v1.0.2-0.5.2/go.mod"
	"github.com/!data!dog/gostackparse v0.7.0"
	"github.com/!data!dog/sketches-go v1.4.2"
	"github.com/!data!dog/sketches-go v1.4.2/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.50.10/go.mod"
	...
	"github.com/ebitengine/purego v0.5.0-alpha.1/go.mod"
	...
	"github.com/google/pprof v0.0.0-20230817174616-7a8ec2ada47b/go.mod"
	...
	"go.etcd.io/etcd/client/pkg/v3 v3.5.11/go.mod"
	"go.etcd.io/etcd/client/v3 v3.5.11"
	"go.etcd.io/etcd/client/v3 v3.5.11/go.mod"
	...
	"google.golang.org/api v0.159.0/go.mod"
	...
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20240116215550-a9fa1716bcac/go.mod"
	...
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.57.0"
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.57.0/go.mod"
	...
	"k8s.io/klog/v2 v2.110.1/go.mod"
...
SRC_URI="https://github.com/coredns/coredns/tarball/8868454177bdd3e70e71bd52d3c0e38bcf0d77fd -> coredns-1.11.2-8868454.tar.gz
https://direct.funtoo.org/06/84/65/06846563e52e0f75bf85485e2bd3b50845e2fdaa8500b67ec084823a0536f8dd7e1bbafd5310a746cb4f42b4c74bf862b133358515b6d2480d09615f60fe2b0e -> coredns-1.11.2-funtoo-go-bundle-4b60453d0200fb83c64ca103da7d16aee2221d855e389bbfc59b1e6b8791d733e548fe91a57f21547c2adad35c4959ac4a4fd1e1d1a67ccc88e2642eab39da7c.tar.gz"
...
S="${WORKDIR}/coredns-coredns-8868454"
