...
EGO_SUM=(
	...
	"github.com/!azure/azure-sdk-for-go v65.0.0+incompatible/go.mod"
	...
	"github.com/!data!dog/sketches-go v1.0.0"
	"github.com/!data!dog/sketches-go v1.0.0/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.44.22/go.mod"
	...
	"github.com/gorilla/mux v1.5.0/go.mod"
	...
	"github.com/jinzhu/gorm v1.9.1/go.mod"
	...
	"github.com/prometheus/common v0.34.0/go.mod"
	...
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.38.1"
	"gopkg.in/!data!dog/dd-trace-go.v1 v1.38.1/go.mod"
...
SRC_URI="https://api.github.com/repos/coredns/coredns/tarball/v1.9.3 -> coredns-v1.9.3.tar.gz
	${EGO_SUM_SRC_URI}"
