...
EGO_SUM=(
	...
	"github.com/!azure/azure-sdk-for-go v55.3.0+incompatible/go.mod"
	...
	"github.com/!click!house/clickhouse-go v1.4.3/go.mod"
	...
	"github.com/!masterminds/squirrel v1.5.1/go.mod"
	...
	"github.com/!puerkito!bio/goquery v1.8.0/go.mod"
	...
	"github.com/!roaring!bitmap/roaring v0.9.4/go.mod"
	"github.com/!severe!cloud/vksdk/v2 v2.13.1"
	"github.com/!severe!cloud/vksdk/v2 v2.13.1/go.mod"
	...
	"github.com/advancedlogic/!go!ose v0.0.0-20210820140952-9d5822d4a625/go.mod"
	...
	"github.com/apache/arrow/go/arrow v0.0.0-20211013220434-5962184e7a30/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.40.42/go.mod"
	"github.com/aws/aws-sdk-go v1.42.11/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.5.4/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/internal/s3shared v1.7.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/s3 v1.12.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/s3 v1.16.1/go.mod"
	...
	"github.com/blevesearch/bleve/v2 v2.3.0/go.mod"
	...
	"github.com/blevesearch/zapx/v11 v11.3.2/go.mod"
	"github.com/blevesearch/zapx/v12 v12.3.2/go.mod"
	"github.com/blevesearch/zapx/v13 v13.3.2/go.mod"
	"github.com/blevesearch/zapx/v14 v14.3.2/go.mod"
	"github.com/blevesearch/zapx/v15 v15.3.2/go.mod"
	...
	"github.com/dhui/dktest v0.3.7/go.mod"
	"github.com/die-net/lrucache v0.0.0-20181227122439-19a39ef22a11/go.mod"
	"github.com/die-net/lrucache v0.0.0-20190707192454-883874fe3947/go.mod"
	...
	"github.com/fasthttp/websocket v1.4.3-rc.9/go.mod"
	"github.com/fasthttp/websocket v1.4.3-rc.10/go.mod"
	...
	"github.com/fcjr/aia-transport-go v1.2.2/go.mod"
	...
	"github.com/gofiber/fiber/v2 v2.20.1/go.mod"
	"github.com/gofiber/websocket/v2 v2.0.12/go.mod"
	...
	"github.com/golang-migrate/migrate/v4 v4.15.1/go.mod"
	...
	"github.com/gomarkdown/markdown v0.0.0-20211207152620-5d6539fd8bfc/go.mod"
	...
	"github.com/gopherjs/gopherjs v0.0.0-20211111143520-d0d5ecc1a356/go.mod"
	...
	"github.com/harmony-development/hrpc v0.0.0-20211020182021-788fc204a0fe/go.mod"
	"github.com/harmony-development/shibshib v0.0.0-20211127182844-512296f7c548"
	"github.com/harmony-development/shibshib v0.0.0-20211127182844-512296f7c548/go.mod"
	...
	"github.com/hashicorp/yamux v0.0.0-20211028200310-0bc27b27de87/go.mod"
	...
	"github.com/jaytaylor/html2text v0.0.0-20211105163654-bc68cce691ba/go.mod"
	...
	"github.com/keybase/go-keybase-chat-bot v0.0.0-20211201215354-ee4b23828b55/go.mod"
	...
	"github.com/klauspost/compress v1.14.2/go.mod"
	...
	"github.com/labstack/echo/v4 v4.6.3/go.mod"
	...
	"github.com/lrstanley/girc v0.0.0-20211023233735-147f0ff77566/go.mod"
	...
	"github.com/matterbridge/go-xmpp v0.0.0-20211030125215-791a06c5f1be/go.mod"
	"github.com/matterbridge/gomatrix v0.0.0-20220205235239-607eb9ee6419"
	"github.com/matterbridge/gomatrix v0.0.0-20220205235239-607eb9ee6419/go.mod"
	...
	"github.com/matterbridge/matterclient v0.0.0-20211107234719-faca3cd42315/go.mod"
	...
	"github.com/mattermost/mattermost-server/v5 v5.39.3/go.mod"
	"github.com/mattermost/mattermost-server/v6 v6.0.0/go.mod"
	"github.com/mattermost/mattermost-server/v6 v6.3.0"
	"github.com/mattermost/mattermost-server/v6 v6.3.0/go.mod"
	...
	"github.com/minio/minio-go/v7 v7.0.16/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20211013025323-ce878158c4d4/go.mod"
	...
	"willnorris.com/go/imageproxy v0.11.2/go.mod"
)
