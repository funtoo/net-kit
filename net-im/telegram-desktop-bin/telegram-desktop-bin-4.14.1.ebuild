...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v4.14.1/tdesktop-4.14.1-full.tar.gz -> tdesktop-4.14.1-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v4.14.1/tsetup.4.14.1.tar.xz -> tsetup.4.14.1.tar.xz"
