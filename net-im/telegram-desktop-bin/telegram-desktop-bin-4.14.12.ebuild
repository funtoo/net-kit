...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v4.14.12/tdesktop-4.14.12-full.tar.gz -> tdesktop-4.14.12-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v4.14.12/tsetup.4.14.12.tar.xz -> tsetup.4.14.12.tar.xz"
