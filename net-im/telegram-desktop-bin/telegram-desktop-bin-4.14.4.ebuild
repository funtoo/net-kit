...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v4.14.4/tdesktop-4.14.4-full.tar.gz -> tdesktop-4.14.4-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v4.14.4/tsetup.4.14.4.tar.xz -> tsetup.4.14.4.tar.xz"
