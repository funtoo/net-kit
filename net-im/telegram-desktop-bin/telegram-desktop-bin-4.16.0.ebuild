...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v4.16.0/tdesktop-4.16.0-full.tar.gz -> tdesktop-4.16.0-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v4.16.0/tsetup.4.16.0.tar.xz -> tsetup.4.16.0.tar.xz"
