...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v4.16.5/tdesktop-4.16.5-full.tar.gz -> tdesktop-4.16.5-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v4.16.5/tsetup.4.16.5.tar.xz -> tsetup.4.16.5.tar.xz"
