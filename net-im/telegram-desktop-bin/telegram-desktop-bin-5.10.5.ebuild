...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v5.10.5/tdesktop-5.10.5-full.tar.gz -> tdesktop-5.10.5-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v5.10.5/tsetup.5.10.5.tar.xz -> tsetup.5.10.5.tar.xz"
