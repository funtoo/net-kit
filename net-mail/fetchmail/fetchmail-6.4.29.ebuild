...
SRC_URI="https://gitlab.com/fetchmail/fetchmail/-/archive/RELEASE_6-4-29/fetchmail-RELEASE_6-4-29.tar.gz -> fetchmail-6.4.29.tar.gz"
...
S="${WORKDIR}/fetchmail-RELEASE_6-4-29"
