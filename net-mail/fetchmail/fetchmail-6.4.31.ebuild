...
SRC_URI="https://gitlab.com/fetchmail/fetchmail/-/archive/RELEASE_6-4-31/fetchmail-RELEASE_6-4-31.tar.gz -> fetchmail-6.4.31.tar.gz"
...
S="${WORKDIR}/fetchmail-RELEASE_6-4-31"
