...
SRC_URI="https://www.github.com/funtoo/dropbox-python-setup/tarball/1.1 -> dropbox-python-setup-1.1.tar.gz
	x86? ( https://edge.dropboxstatic.com/dbx-releng/client/dropbox-lnx.x86-195.4.4995.tar.gz -> dropbox-lnx.x86-195.4.4995.tar.gz )
	amd64? ( https://edge.dropboxstatic.com/dbx-releng/client/dropbox-lnx.x86_64-195.4.4995.tar.gz -> dropbox-lnx.x86_64-195.4.4995.tar.gz )
	gnome? ( https://linux.dropbox.com/packages/nautilus-dropbox-2024.01.22.tar.bz2 -> nautilus-dropbox-2024.01.22.tar.bz2 )"
...
pkg_setup() {
	...
	if use gnome; then
		S="$WORKDIR/nautilus-dropbox-2024.01.22"
	else
		S="$WORKDIR"
	fi
...
src_unpack() {
	if use gnome; then
		unpack nautilus-dropbox-2024.01.22.tar.bz2
	fi
