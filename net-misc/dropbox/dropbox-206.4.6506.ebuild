...
SRC_URI="amd64? ( https://edge.dropboxstatic.com/dbx-releng/client/dropbox-lnx.x86_64-206.4.6506.tar.gz -> dropbox-lnx.x86_64-206.4.6506.tar.gz )
gnome? ( https://linux.dropbox.com/packages/nautilus-dropbox-2024.04.17.tar.bz2 -> nautilus-dropbox-2024.04.17.tar.bz2 )
https://www.github.com/funtoo/dropbox-python-setup/tarball/1.1 -> dropbox-python-setup-1.1.tar.gz
"
