...
EGO_SUM=(
	...
	"github.com/ProtonMail/go-crypto v0.0.0-20220623141421-5afb4c282135/go.mod"
	...
	"github.com/anacrolix/dms v1.4.0/go.mod"
	...
	"github.com/anacrolix/log v0.10.1-0.20220126091220-5c1b6f3af59c"
	"github.com/anacrolix/log v0.10.1-0.20220126091220-5c1b6f3af59c/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.44.29/go.mod"
	...
	"github.com/gdamore/tcell/v2 v2.5.1/go.mod"
	...
	"github.com/jlaffaye/ftp v0.0.0-20220524001917-dfa1e758f3af/go.mod"
	...
	"github.com/pkg/sftp v1.13.5-0.20211228200725-31aac3e1878d/go.mod"
	...
	"google.golang.org/api v0.83.0/go.mod"
...
KEYWORDS="*"
SRC_URI="https://github.com/rclone/rclone/releases/download/v1.59.2/rclone-v1.59.2.tar.gz -> rclone-v1.59.2.tar.gz
	${EGO_SUM_SRC_URI}"
