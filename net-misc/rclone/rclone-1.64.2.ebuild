...
EGO_SUM=(
	...
	"github.com/!azure!a!d/microsoft-authentication-library-for-go v1.0.0/go.mod"
	...
	"github.com/!proton!mail/gopenpgp/v2 v2.7.3"
	"github.com/!proton!mail/gopenpgp/v2 v2.7.3/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.44.311/go.mod"
	...
	"github.com/henrybear327/!proton-!a!p!i-!bridge v0.0.0-20230908065933-5bfa15b567db"
	"github.com/henrybear327/!proton-!a!p!i-!bridge v0.0.0-20230908065933-5bfa15b567db/go.mod"
	"github.com/henrybear327/go-proton-api v0.0.0-20230907193451-e563407504ce"
	"github.com/henrybear327/go-proton-api v0.0.0-20230907193451-e563407504ce/go.mod"
	...
	"github.com/jtolio/noiseconn v0.0.0-20230111204749-d7ec1a08b0b8/go.mod"
	...
	"github.com/oracle/oci-go-sdk/v65 v65.45.0/go.mod"
	...
	"github.com/spacemonkeygo/monkit/v3 v3.0.20-0.20230227152157-d00b379de191/go.mod"
	...
	"golang.org/x/mobile v0.0.0-20230531173138-3c911d8e3eda/go.mod"
	...
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20230720185612-659f7aaaa771/go.mod"
	...
	"storj.io/common v0.0.0-20230907123639-5fd0608fd947/go.mod"
	...
	"storj.io/uplink v1.12.0/go.mod"
)

go-module_set_globals

KEYWORDS="*"
SRC_URI="https://github.com/rclone/rclone/tarball/68266cb4355a68dcdeed08b296bfc732f4ee6cea -> rclone-1.64.2-68266cb.tar.gz
https://direct.funtoo.org/4f/48/43/4f4843102ee2c31418974a8d8b4b857fddc0c8f3ebedc4ca9024c02b8d4d77e42535b2300d102a38dddc9cc5c15b56435f0926f67a87458fa513468aaef1b3fe -> rclone-1.64.2-funtoo-go-bundle-6d836ab83efd7641eadfe41564bf0a967007e940d3a4a391246527920ebb7451802f90d311673e4ecc71c2692c763ffb8f38c2aab28ca3c8b3361f7b96c41816.tar.gz"
