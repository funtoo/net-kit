...
EGO_SUM=(
	...
	"cloud.google.com/go/compute v1.23.2/go.mod"
	...
	"github.com/!azure/azure-sdk-for-go/sdk/internal v1.4.0/go.mod"
	...
	"github.com/!azure/azure-sdk-for-go/sdk/storage/azfile v1.1.0/go.mod"
	...
	"github.com/anacrolix/log v0.14.2/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.46.6/go.mod"
	"github.com/beorn7/perks v1.0.1"
	"github.com/beorn7/perks v1.0.1/go.mod"
	"github.com/bradenaw/juniper v0.13.1"
	"github.com/bradenaw/juniper v0.13.1/go.mod"
	...
	"github.com/cloudsoda/go-smb2 v0.0.0-20231106205947-b0758ecc4c67/go.mod"
	...
	"github.com/emersion/go-message v0.17.0/go.mod"
	...
	"github.com/jtolio/noiseconn v0.0.0-20230621152802-afeab29449e0"
	"github.com/jtolio/noiseconn v0.0.0-20230621152802-afeab29449e0/go.mod"
	...
	"github.com/oracle/oci-go-sdk/v65 v65.51.0/go.mod"
	...
	"github.com/willscott/go-nfs v0.0.0-20231028170411-e6abde417d5d/go.mod"
	"github.com/willscott/go-nfs-client v0.0.0-20200605172546-271fa9065b33"
	"github.com/willscott/go-nfs-client v0.0.0-20200605172546-271fa9065b33/go.mod"
	...
	"github.com/zema1/go-nfs-client v0.0.0-20200604081958-0cf942f0e0fe/go.mod"
	...
	"golang.org/x/mobile v0.0.0-20231006135142-2b44d11868fe/go.mod"
	...
	"storj.io/common v0.0.0-20231027080355-b4cb1b0d728e/go.mod"
	...
	"storj.io/uplink v1.12.1/go.mod"
)

go-module_set_globals

KEYWORDS="*"
SRC_URI="https://github.com/rclone/rclone/tarball/52f026517af4dc93bcf6537f03d653fc5581e29d -> rclone-1.65.0-52f0265.tar.gz
https://direct.funtoo.org/ad/d4/dc/add4dc49dec3873b4d08139d50f90e42d651c5dedcb6934af3100cb723db2ffd68b0e83d9dc5018d801413ccb514a956509b37cf8433faa1aee211d6879c5543 -> rclone-1.65.0-funtoo-go-bundle-d419be3ed2e8498b24ffb631386aa6a8990070ff0a5ed59e97a896925410b8af39460d0b0baad5fcc87cacf73434087472250c3b0e57484e65f65f1237d849c7.tar.gz"
