...
EGO_SUM=(
	...
	"github.com/greatroar/blobloom v0.7.1/go.mod"
	...
	"github.com/klauspost/cpuid/v2 v2.1.1/go.mod"
	...
	"github.com/lucas-clemente/quic-go v0.29.0/go.mod"
	...
	"github.com/maruel/panicparse v1.6.2/go.mod"
	...
	"github.com/petermattis/goid v0.0.0-20220824145935-af5520614cb6/go.mod"
	...
	"github.com/shirou/gopsutil/v3 v3.22.8/go.mod"
...
SRC_URI="https://api.github.com/repos/syncthing/syncthing/tarball/v1.22.0 -> syncthing-v1.22.0.tar.gz
	${EGO_SUM_SRC_URI}"
