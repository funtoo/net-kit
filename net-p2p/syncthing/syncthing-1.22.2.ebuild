...
EGO_SUM=(
	...
	"github.com/google/pprof v0.0.0-20221112000123-84eb7ad69597/go.mod"
	...
	"github.com/klauspost/cpuid/v2 v2.2.1/go.mod"
	...
	"github.com/lucas-clemente/quic-go v0.31.0/go.mod"
	...
	"github.com/petermattis/goid v0.0.0-20221018141743-354ef7f2fd21/go.mod"
...
SRC_URI="https://api.github.com/repos/syncthing/syncthing/tarball/v1.22.2 -> syncthing-v1.22.2.tar.gz
	${EGO_SUM_SRC_URI}"
