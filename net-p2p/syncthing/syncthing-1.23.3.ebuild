...
EGO_SUM=(
	...
	"github.com/petermattis/goid v0.0.0-20230222173705-8ff7bb262a50/go.mod"
	...
	"golang.org/x/exp v0.0.0-20230307190834-24139beb5833/go.mod"
...
SRC_URI="https://github.com/syncthing/syncthing/tarball/e8dafb979cd3d8a1e35dcf3ca472c59531c8662b -> syncthing-1.23.3-e8dafb9.tar.gz
	${EGO_SUM_SRC_URI}"
...
KEYWORDS="*"
IUSE="tools"
S="${WORKDIR}/syncthing-syncthing-e8dafb9"
