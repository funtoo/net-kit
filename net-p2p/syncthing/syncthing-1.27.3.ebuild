...
EGO_SUM=(
	...
	"github.com/google/pprof v0.0.0-20231229205709-960ae82b1e42/go.mod"
	...
	"github.com/maxbrunsfeld/counterfeiter/v6 v6.7.0/go.mod"
	...
	"github.com/shirou/gopsutil/v3 v3.23.11/go.mod"
	...
	"github.com/willabides/kongplete v0.3.0/go.mod"
	...
	"golang.org/x/exp v0.0.0-20240103183307-be819d1f06fc/go.mod"
...
SRC_URI="https://github.com/syncthing/syncthing/tarball/8e44af855cd44e6d32f63de7b3e0bae40bcfdd39 -> syncthing-1.27.3-8e44af8.tar.gz
https://direct.funtoo.org/dc/e4/fc/dce4fc5a7d122b44f4e93884b8fd93f3d82c3ca9dcf1cddfb437eb321da851a03e8d54be394d220900c400801d7c674c93bc9b59582bc69a210b6139ef31cc1d -> syncthing-1.27.3-funtoo-go-bundle-93556e9b3cc97d61dd472bf7879361290c4232568b25a332dcbfec4537d1e94036eb7787319902dacafc77e883eeb02b31e7e53cacbac8ddf91aa020fff1f064.tar.gz"

LICENSE="Apache-2.0 BSD BSD-2 ISC MIT MPL-2.0 Unlicense"
SLOT="0"
KEYWORDS="*"
IUSE="tools"
S="${WORKDIR}/syncthing-syncthing-8e44af8"
