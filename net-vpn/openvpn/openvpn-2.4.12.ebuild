...
SRC_URI="https://github.com/OpenVPN/openvpn/archive/0d927554ed846b4e512e394c8cf8d5e116df10ba.tar.gz -> openvpn-2.4.12-0d92755.tar.gz"
...
src_unpack() {
    default
    mv "openvpn-0d927554ed846b4e512e394c8cf8d5e116df10ba" "${S}" || die
}
