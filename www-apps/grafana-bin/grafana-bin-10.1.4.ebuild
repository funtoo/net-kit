...
SRC_URI="
	amd64? ( https://dl.grafana.com/oss/release/grafana-10.1.4.linux-amd64.tar.gz -> grafana-10.1.4.linux-amd64.tar.gz )
	arm64? ( https://dl.grafana.com/oss/release/grafana-10.1.4.linux-arm64.tar.gz -> grafana-10.1.4.linux-arm64.tar.gz )
"
