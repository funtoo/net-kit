...
SRC_URI="
	amd64? ( https://dl.grafana.com/oss/release/grafana-9.3.6.linux-amd64.tar.gz -> grafana-9.3.6.linux-amd64.tar.gz )
	arm64? ( https://dl.grafana.com/oss/release/grafana-9.3.6.linux-arm64.tar.gz -> grafana-9.3.6.linux-arm64.tar.gz )
"
